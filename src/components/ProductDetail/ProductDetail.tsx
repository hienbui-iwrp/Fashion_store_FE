      ...
      <Row className=''>
        <Col span={9}>
          <div className='flex justify-center'>
            <Image width={350} height={400} className='py-2' src={imageShow} alt='' />
          </div>
        ...
        <Col span={15}>
          <Title level={3} className='pb-8'> sản phẩm x</Title>
          <div className='flex flex-col'>
            ...
            <Space>
              ...
              <Text strong className='text-[#6A983C]'>Còn hàng</Text>
            </Space>
          </div>
          <div className='mt-8'>
            <Space>
              <Text className='text-[#A9A9A9] flex w-28'>Màu sắc:</Text>
              <Radio.Group buttonStyle="solid" onChange={onChangeColor} defaultValue="a" className={styles.productColor}>
          ...
          <div className='mt-8'>
            <Space>
              ...
              <Radio.Group buttonStyle="solid" onChange={onChangeColor} defaultValue="a" className={styles.productSize}>
          ...
          <div className='flex justify-between items-center mt-10'>
            ...
            <div>
              ...
              />
              <InputNumber className='mx-2' size="small" min={1} max={1000} value={quantity} onChange={onChangeQuantity} />
              <PlusCircleOutlined className='cursor-pointer text-lg'
                onClick={() => { onChangeQuantity(quantity + 1) }}
              />
            </div>
            <ButtonClientPrimary name='Thêm vào giỏ hàng' iconInput={<FontAwesomeIcon className="text-xl p-2" icon={faCartPlus} />} />
          </div>
        </Col>
      </Row>
