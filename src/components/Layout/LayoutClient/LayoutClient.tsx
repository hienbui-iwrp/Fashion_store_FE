        ...
        <Row className='flex'>
          <Col span={15} className="flex items-center ">
            <a href="#" className='flex'>
              <Image width='150px' className='pl-10' src='/logo_pth.png' preview={false}
        ...
        <Row gutter={16}>
          <Col className="gutter-row" span={12}>
            <div>
              ...
              <Typography className='text-white'>268 Lý Thường Kiệt, Quận 10, Tp.HCM</Typography>
              <Typography className='text-white'>0867742135</Typography>
              <Typography className='text-white'>sp.pfashion1@gmail.com</Typography>
              <div className='flex mt-1 space-x-6'>
                <a href="#" className="text-yellow-600 hover:text-yellow-400 dark:hover:text-yellow-400">
                  {iconFb}
                </a>
                <a href="#" className="text-yellow-600 hover:text-yellow-400 dark:hover:text-yellow-400">
                  {iconIg}
